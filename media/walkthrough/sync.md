...
**Sync** is the only action that fetches from Xray. It pulls remote metadata, status, and requirement coverage for the tests your scenarios reference, plus the catalogue needed to flag orphan tests.
