  ...
  public registerCommands(context: vscode.ExtensionContext): void {
    try {
      ...
      const commands: CommandOptions[] = [
        ...
        { command: "playwrightBddRunner.traceability.selectSyncProjects", title: "Select Projects to Sync", category: CATEGORY, handler: () => this.traceabilityCommands.selectSyncProjects() },
